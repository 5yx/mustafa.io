...
LoadingState.preload = function () {
    ...
    this.game.load.spritesheet('chars', 'images/chars.png', 458, 200);
    this.game.load.spritesheet('hb', 'images/hb.png', 480, 158);
...
PlayState._loadLevel = function (data) {
    ...
    this.addons = this.game.add.group();
    ...
    data.addons.forEach(this._spawnAddons, this);
...
PlayState._spawnAddons = function (addon) {
    let sprite = this.addons.create(addon.x, addon.y, addon.image);
    ...
    // animations
    sprite.animations.add('animate', addon.seq, addon.fps, true); // 6fps, looped
